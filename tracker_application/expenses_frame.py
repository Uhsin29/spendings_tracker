...
def relative_to_assets_expense_frame(path: str) -> str:
...
class ExpensesFrame(Frame):
    def __init__(self, master, return_callback):
        ...
        self.image_image_1 = PhotoImage(
            file=relative_to_assets_expense_frame("expense_image.png"))
        ...
        self.button_image_1 = PhotoImage(
            file=relative_to_assets_expense_frame("button_1.png"))
        ...
        self.back = PhotoImage(
            file=relative_to_assets_expense_frame("back_button.png"))
